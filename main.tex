...
\begin{document}
	...
	\begin{thebibliography}{00}
		...
		\bibitem{b6_2} Xiaoling Xia, Cui Xu, and Bing Nan, ``Inception-v3 for flower classification,'' in 2017 2nd International Conference on Image, Vision and Computing (ICIVC), 2017.
	\end{thebibliography}
\end{document}
